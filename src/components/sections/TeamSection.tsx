...
export default function TeamSection() {
  // Preload client image when section is about to be visible
  useEffect(() => {
  ...
  const contactMethods = [
    {
      icon: Mail,
      title: 'Contact Email',
      value: 'H.smaiti@ocpgroup.ma',
      link: 'mailto:H.smaiti@ocpgroup.ma',
      color: '#2FA36F',
    },
    {
      icon: FileText,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="text-center mb-12">
            <div className="relative w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-emerald-500/30 shadow-lg shadow-emerald-500/20 bg-gradient-to-br from-emerald-500/15 to-teal-500/15 flex items-center justify-center">
              <ImageWithFallback
                src={HichamImage}
                alt="Hicham Smaiti"
