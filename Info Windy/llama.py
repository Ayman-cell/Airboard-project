...
if not CEREBRAS_API_KEY:
    st.error("❌ Clé API Cerebras manquante!")
    st.info("💡 La variable d'environnement CEREBRAS_API_KEY est requise")
    st.info("📝 Pour configurer votre clé API, exécutez: python setup_env.py")
    st.info("📖 Ou créez un fichier .env avec: CEREBRAS_API_KEY=votre_cle_ici")
    st.stop()
